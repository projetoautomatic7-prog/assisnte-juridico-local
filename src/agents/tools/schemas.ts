...
export type LegalResearchToolOutput = z.infer<
  typeof LegalResearchToolOutputSchema
>;
...
export const DJENMonitorToolSchema = z.object({
  oab_number: z
    .string()
    .regex(/^[A-Z]{2}\d{6}$/, "Formato OAB inválido (ex: SP123456)"),
  advogado_nome: z.string().min(3, "Nome do advogado muito curto"),
  dias_retroativos: z
    .number()
    .min(1)
    .max(30, "Máximo 30 dias retroativos")
    .default(7),
  tribunais: z
    .array(
      z.enum([
...
export const DocumentAnalysisToolSchema = z
  .object({
    ...
    document_text: z
      .string()
      .min(10, "Texto do documento muito curto")
      .optional(),
...
export type DocumentAnalysisToolInput = z.infer<
  typeof DocumentAnalysisToolSchema
>;
...
export type DocumentAnalysisToolOutput = z.infer<
  typeof DocumentAnalysisToolOutputSchema
>;
...
export const PrazoCalculatorToolSchema = z.object({
  ...
  tipo_prazo: z.enum(["corridos", "uteis"], {
    errorMap: () => ({
      message: "Tipo de prazo deve ser 'corridos' ou 'uteis'",
    }),
  }),
...
export type PrazoCalculatorToolInput = z.infer<
  typeof PrazoCalculatorToolSchema
>;
...
export type PrazoCalculatorToolOutput = z.infer<
  typeof PrazoCalculatorToolOutputSchema
>;
...
export type LegislationSearchToolInput = z.infer<
  typeof LegislationSearchToolSchema
>;
...
export type LegislationSearchToolOutput = z.infer<
  typeof LegislationSearchToolOutputSchema
>;
